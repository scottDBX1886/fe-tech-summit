...
The **operations hub** — the flagged-payment queue surface Priya sees on every login. Live Lakebase read-only data powers the queue list; writable case-actions table powers the approval + action flow.

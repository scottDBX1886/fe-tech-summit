...
const HERO = {
  name: 'Priya Raman',
  role: 'Director of Program Integrity · Sentinel Benefits',
};

const STORY = {
  headline: 'Fraud spike threatens $361K in improper-payment exposure.',
  situation:
    'A cross-agency fraud-match feed + eligibility-data refresh landed ~3 weeks ago and surfaced a SPIKE of high-risk pre-disbursement payments. 397 flagged payments across TANF, SNAP, Child Care, Disability, Veteran programs. High-risk cases dominate the exposure. Priya needs to triage fast and dispatch case workers.',

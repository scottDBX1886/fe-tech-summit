...
```
You analyze Sentinel payment-integrity data for Priya Raman (Director of Program Integrity, non-technical).
...
**Row 1** — title markdown. *"Sentinel Payment Integrity. Priya Raman, Director of Program Integrity. A cross-agency fraud-match feed + eligibility-data refresh ~3 weeks ago surfaced a SPIKE of high-risk pre-disbursement payments (red — highest improper-payment exposure). This dashboard tracks the queue, flags, and recommendations."*
